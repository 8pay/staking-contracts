 ...
 */
contract StakePoolWithLockPeriod is Ownable {
    ...
    function deposit(uint256 amount) external {
        ...
        userInfo.lastDepositAt = block.timestamp;
    ...
    function withdraw(uint256 amount) external {
        ...
        require(
            userInfo.lastDepositAt + lockPeriod <= block.timestamp,
